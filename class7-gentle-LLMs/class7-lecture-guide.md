...
- Setting up the Colab environment (no API key required)
- Loading and running basic models
...
| **Huggingface** | Open ML platform for NLP | Model access and experimentation |
| **Pipeline** | Simple interface for ML tasks | Quick prototyping |
| **Colab** | Cloud-based Python notebooks | Hands-on experimentation |
